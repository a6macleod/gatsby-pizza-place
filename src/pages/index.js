    ...
    <Layout>
      ...
      <StyledIndex>
        <div className="about">
          <h3>lorem Ipsum</h3>
          <p>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Vero corporis assumenda laboriosam necessitatibus
            quasi mollitia quaerat distinctio ex sunt recusandae quas dolore voluptate error, quisquam nisi obcaecati
            totam quibusdam. Distinctio?
          </p>
        </div>
        <div className="menu">
          <h3>Menu</h3>
